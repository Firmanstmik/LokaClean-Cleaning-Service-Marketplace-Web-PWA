...
const translations = {
  id: {
    ...
    completeProfile: {
      ...
      houseDetailLabel: "Detail Rumah / Patokan Tambahan",
      houseDetailPlaceholder: "Contoh: Rumah cat hijau, pagar hitam, gang kecil setelah warung...",
      completed: "Lengkap",
      optional: "Opsional",
  ...
  en: {
    ...
    completeProfile: {
      ...
      houseDetailLabel: "Extra House Details / Landmarks",
      houseDetailPlaceholder: "e.g. Green house, black fence, small alley after the mini market...",
      completed: "Completed",
      optional: "Optional",
      required: "Required",
      noteTitle: "Important",
