...
import { Package, ArrowRight, CheckCircle2, Plus, Star, Award, Sparkles, TrendingUp, Clock, Shield, Zap, Eye, X, Info, Square, Droplets, Bed, Box, Home, Sparkle, Wand2, ChevronLeft, ChevronRight, Banknote } from "lucide-react";
...
export function PackagesPage() {
  ...
  const categories = [
    { id: "all", label: t("packages.title"), icon: Package },
    { id: "popular", label: t("packages.popular"), icon: TrendingUp },
    { id: "premium", label: t("packages.premium"), icon: Award }
  ];
  ...
  // Ensure at least 3 items for the carousel by duplicating if necessary
  // This enables infinite rolling even with few items
  let carouselItems = [...filteredItems];
  if (carouselItems.length > 0 && carouselItems.length < 3) {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-tropical-50 via-ocean-50/50 to-sand-50/70">
      {/* Professional Card Header with CTA Button */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-6 py-5 sm:py-6 lg:py-7">
        {/* Category Pills - Modern App Style */}
        <motion.div
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex gap-2.5 sm:gap-3 mb-6 sm:mb-7 overflow-x-auto pb-2 scrollbar-hide -mx-4 sm:-mx-5 lg:-mx-6 px-4 sm:px-5 lg:px-6"
        >
          {categories.map((cat) => {
            const Icon = cat.icon;
            return (
              <motion.button
                ...
                className={`flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-semibold text-xs sm:text-sm whitespace-nowrap transition-all ${
        ...
        {/* Premium Package Cards Carousel - Pyramid Layout */}
                  ...
                  return (
                    ...
                    >
                      ...
                      <motion.div 
                        ...
                        whileHover={isCenter ? {
                          boxShadow: "0 32px 80px rgba(26, 188, 156, 0.4), 0 16px 40px rgba(52, 152, 219, 0.3), 0 8px 20px rgba(139, 92, 246, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.6)"
                        } : {}}
                    ...
                    <div className="relative z-10 p-3 sm:p-5 lg:p-6">
                      ...
                      <div className="mb-3 sm:mb-5">
                        ...
                        >
                          ...
                          <motion.div 
                            className="relative overflow-hidden rounded-2xl sm:rounded-3xl border-2 border-white/40 shadow-2xl bg-gradient-to-br from-slate-100 via-white to-slate-50 backdrop-blur-sm"
                            whileHover={{
                              borderColor: "rgba(26, 188, 156, 0.5)",
                              boxShadow: "0 20px 60px rgba(26, 188, 156, 0.3), 0 10px 30px rgba(52, 152, 219, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.8)"
                            }}
                            transition={{ duration: 0.4, ease: "easeOut" }}
                          >
                            ...
                            <motion.img
                              src={packageImage}
                              alt={packageImageAlt}
                              className="relative w-full h-24 sm:h-44 lg:h-48 object-cover"
                              whileHover={{
                                scale: 1.12,
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          whileHover={{
                            height: "2px",
                            background: "linear-gradient(90deg, rgba(26, 188, 156, 0.5) 0%, rgba(52, 152, 219, 0.5) 50%, rgba(139, 92, 246, 0.5) 100%)"
                          }}
                          viewport={{ once: true }}
                      ...
                      <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-2 sm:mb-5">
                        ...
                        >
                          ...
                          <span className="relative z-10">{t("packages.professional")}</span>
                        </motion.div>
                        <motion.div 
                        ...
                        >
                          ...
                          />
                          <CheckCircle2 className="h-2.5 w-2.5 sm:h-3 sm:w-3 flex-shrink-0 relative z-10" />
                          <span className="relative z-10">{t("packages.fast")}</span>
                        </motion.div>
                      </div>
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-3 mt-2 sm:mt-4">
                        ...
                        <motion.button
                          whileHover={{ scale: 1.02, y: -2, boxShadow: "0 15px 30px -5px rgba(13, 148, 136, 0.4)" }}
                          whileTap={{ scale: 0.98 }}
        ...
        {/* Trust Badges Section - Mobile App Style */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.6 }}
          className="mt-8 sm:mt-10 lg:mt-12 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4"
        >
          {[
            { icon: Shield, text: t("packages.guaranteed"), color: "from-emerald-500 to-teal-600" },
            { icon: Clock, text: t("packages.fast"), color: "from-blue-500 to-indigo-600" },
            { icon: Award, text: t("packages.professional"), color: "from-purple-500 to-pink-600" },
            { icon: Star, text: t("packages.topRated"), color: "from-amber-500 to-orange-600" }
          ].map((badge, i) => {
            ...
            return (
              <motion.div
                ...
                className="card-lombok flex items-center gap-2 sm:gap-3 p-3 sm:p-4"
              >
                <div className={`flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-br ${badge.color} shadow-md flex-shrink-0`}>
                ...
                <div className="overflow-y-auto flex-1">
                  ...
                  <div className="relative w-full h-32 sm:h-40 overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 bg-gradient-to-t from-black/70 to-transparent">
                      <h2 className="text-lg sm:text-xl font-black text-white mb-1 line-clamp-1">
                        ...
                        {extractFeatures(isEnglish && selectedPackage.description_en ? selectedPackage.description_en : selectedPackage.description).map((feature, idx) => {
                          ...
                          return (
                            <motion.div
                              ...
                              className={`flex items-center gap-1.5 sm:gap-2 p-2 sm:p-2.5 rounded-lg sm:rounded-xl border ${feature.bgColor}`}
                            >
                              <Icon className={`h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 ${iconColor}`} />
                              <span className={`text-xs sm:text-sm font-semibold ${feature.color} line-clamp-1`}>
                                {feature.text}
                              </span>
                            </motion.div>
                          );
