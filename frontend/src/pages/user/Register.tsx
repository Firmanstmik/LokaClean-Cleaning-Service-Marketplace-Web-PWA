...
export function UserRegister() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-white overflow-hidden">
      <Helmet>
        <title>Daftar LokaClean | Jasa Kebersihan Lombok</title>
      </Helmet>
      ...
      >
        ...
        <div className="relative z-10 p-12 text-white max-w-xl">
          ...
          >
            ...
            >
              <img src="/img/Logo_LokaClean_fixed.webp" alt="Logo" className="h-20 w-20 object-contain drop-shadow-lg rounded-2xl" />
            </motion.div>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-white/20 sm:backdrop-blur-md border border-white/30 shadow-lg">
                    <img src="/img/Logo_LokaClean_fixed.webp" alt="Logo" className="h-16 w-16 object-contain rounded-xl" />
                  </div>
                </div>
